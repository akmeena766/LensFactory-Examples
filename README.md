...
This repository contains examples for [`LensFactory`](https://github.com/akmeena766/LensFactory.jl) package. The list (and small description) of these examples is as follows:
   1. <ins>Example-1: Constants and Cosmology</ins>: This example describes the basic use of available **constants** and **cosmology** in `LensFactory` package.

   2. <ins>Example-2: Basic strong lensing</ins>: 